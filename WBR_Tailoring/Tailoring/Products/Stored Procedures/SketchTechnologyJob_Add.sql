CREATE PROCEDURE [Products].[SketchTechnologyJob_Add]
	@sketch_id INT,
	@employee_id INT
AS
	SET NOCOUNT ON
	...
	SELECT	@error_text = CASE 
	      	                   ...
	      	                   WHEN oa.create_dt IS NOT NULL THEN 'На этот эскиз ' + CAST(v.sketch_id AS VARCHAR(10)) +
	      	                        ' уже есть задание на техпоследовательность, добавленное ' + CONVERT(VARCHAR(20), oa.create_dt, 121) + ' сотрудником с кодом ' +
