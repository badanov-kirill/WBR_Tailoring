CREATE PROCEDURE [Planing].[SketchPlanColorVariant_GetForConfectioner]
AS
	SET NOCOUNT ON
	...
	WHERE	((spcv.cvs_id = @cv_status_layout_close AND spcv.pan_id IS NOT NULL) OR spcv.cvs_id = @cv_status_corr_reserv)
