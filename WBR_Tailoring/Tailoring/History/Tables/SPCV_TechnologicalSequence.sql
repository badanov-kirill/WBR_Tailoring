CREATE TABLE [History].[SPCV_TechnologicalSequence]
(
	log_id              INT IDENTITY(1, 1) CONSTRAINT [PK_Hystory_SPCV_TechnologicalSequence] PRIMARY KEY CLUSTERED NOT NULL,
	sts_is              INT NOT NULL,
