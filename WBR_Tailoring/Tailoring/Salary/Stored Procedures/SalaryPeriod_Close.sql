CREATE PROCEDURE [Salary].[SalaryPeriod_Close]
...
AS
	...
	SELECT	@error_text = CASE 
	      	                   ...
	      	                   WHEN sp.close_period_dt IS NOT NULL THEN 'Зарплатный период уже закрыт'
	      	                   ELSE NULL
	      	              END,
