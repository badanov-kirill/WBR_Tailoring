CREATE PROCEDURE [Logistics].[TransferBoxSpecial_UnPrint]
...
AS
	...
	SELECT	@error_text = CASE 
	      	                   ...
	      	                   WHEN tbs.print_dt IS NULL THEN 'Коробка с кодом ' + CAST(v.transfer_box_id AS VARCHAR(20)) + ' не напечатана.'
	      	                   ELSE NULL
	      	              END
