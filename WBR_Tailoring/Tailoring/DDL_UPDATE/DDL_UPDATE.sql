...
ALTER TABLE [Planing].[SketchPlan]  ALTER COLUMN sew_fabricator_id INTEGER  NULL;
...
ALTER TABLE[Planing].[SketchPlanColorVariant]  ALTER COLUMN sew_fabricator_id INTEGER  NULL;
...
ALTER TABLE [Warehouse].[SHKRawMaterialActualInfo] ALTER COLUMN fabricator_id INTEGER NULL;
...
ALTER TABLE Material.RawMaterialIncome ALTER COLUMN fabricator_id INTEGER  NULL
